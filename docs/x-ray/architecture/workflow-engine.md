...
- Retry: exponential backoff `1s·2^n` (`calculateRetryDelay:296`), record marked FAILED then `RuntimeException` rethrown for BPMN error boundaries (lines 265-273) — otherwise the Flowable async executor/incident behavior applies.
