-- Inbound email monitoring (admin-center runtime sync target).
-- Mirrors init-scripts 49-sys-email-monitor-rules.sql. Idempotent: coexists with dev init-scripts.
