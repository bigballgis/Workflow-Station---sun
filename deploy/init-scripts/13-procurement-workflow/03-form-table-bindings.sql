...
BEGIN
    ...
    SET config_json = jsonb_set(
        ...
        '{subForms}',
        jsonb_build_object(
            -- RequestItems 子表单字段配置
            v_items_table_id::text, '{
                "rule": [
                    {"name":"ref_Fj8smm1s0sq3akc","type":"input","field":"item_name","props":{"maxlength":200,"placeholder":"Please input Item Name","showWordLimit":true},"title":"Item Name","_fc_id":"id_F10nmm1s0sq3ajc","hidden":false,"display":true,"validate":[{"message":"Item Name required","trigger":"blur","required":true}],"_fc_drag_tag":"input"},
                    {"name":"ref_Fspimm1s0sq3amc","type":"inputNumber","field":"unit_price","props":{"precision":2,"placeholder":"Please input Unit Price"},"title":"Unit Price","_fc_id":"id_Fhv3mm1s0sq3alc","hidden":false,"display":true,"validate":[{"message":"Unit Price required","trigger":"blur","required":true}],"_fc_drag_tag":"inputNumber"},
            ...
            -- RequestAttachments 子表单字段配置
            v_attach_table_id::text, '{
                "rule": [
    ...
    RAISE NOTICE 'Request Form (id=%) : 3 bindings, subForms updated (keys: %, %)',
        v_request_form_id, v_items_table_id, v_attach_table_id;
