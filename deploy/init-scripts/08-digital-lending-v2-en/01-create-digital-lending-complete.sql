...
BEGIN
    ...
    INSERT INTO dw_function_units (
        code, name, display_name, status, version, is_active,
    ...
    INSERT INTO dw_table_definitions (
        function_unit_id, table_name, table_type, display_name
    ) VALUES (
    ...
    INSERT INTO dw_field_definitions (
        table_id, field_name, data_type, length, scale, nullable, display_name, sort_order
    ) VALUES
    ...
    INSERT INTO dw_form_definitions (
        function_unit_id, form_name, form_type, config_json, display_name, bound_table_id
    ) VALUES (
...
$dmn$,
    ...
    INSERT INTO dw_action_definitions (function_unit_id, action_name, action_type, display_name, config_json, icon, button_color) VALUES
