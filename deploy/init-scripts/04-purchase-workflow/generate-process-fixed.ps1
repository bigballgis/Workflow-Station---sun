# Purchase Request Process - Generate Process Definition SQL with Correct Form IDs
...
$sql = @"
-- Purchase Request - Process Definition with Correct Form IDs
-- Form IDs: Main=11, Approval=13, Countersign=16
...
[System.IO.File]::WriteAllText("deploy/init-scripts/04-purchase-workflow/04-08-process-fixed.sql", $sql, [System.Text.Encoding]::UTF8)

Write-Host "SQL file generated: 04-08-process-fixed.sql"
