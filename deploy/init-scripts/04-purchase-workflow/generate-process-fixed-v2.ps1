# Purchase Request Process - Generate Process Definition SQL with Correct Form IDs AND Action IDs
# Form IDs: Main=11, Approval=13, Countersign=16
# Action IDs: Submit=21, Approve=22, Reject=23, Transfer=24, Rollback=25, Withdraw=26, QueryBudget=27, CalcAmount=28, SaveDraft=29, StartCountersign=30
...
$sql = @"
-- Purchase Request - Process Definition with Correct Form IDs AND Action IDs
-- Form IDs: Main=11, Approval=13, Countersign=16
-- Action IDs: Submit=21, Approve=22, Reject=23, Transfer=24, Rollback=25, Withdraw=26, QueryBudget=27, CalcAmount=28, SaveDraft=29, StartCountersign=30
...
[System.IO.File]::WriteAllText("04-08-process-fixed-v2.sql", $sql, [System.Text.Encoding]::UTF8)

Write-Host "SQL file generated: 04-08-process-fixed-v2.sql"
