-- =============================================================================
-- 12-simple-approval: Create BPMN Process Definition
-- 基于数据库实际数据生成
-- BPMN 存储为 base64 编码，与源数据库一致
-- 流程: Start → Submit Request (formId=Request Form) → Manager Approval (formId=Request Form, readOnly)
...
BEGIN
    ...
    IF v_request_form_id IS NULL THEN
        RAISE EXCEPTION 'Request Form not found. Run 00-create-function-unit.sql first.';
    END IF;
    IF v_action_submit_id IS NULL OR v_action_approve_id IS NULL OR v_action_reject_id IS NULL THEN
        RAISE EXCEPTION 'One or more actions not found. Run 00-create-function-unit.sql first.';
    END IF;

    -- Build BPMN XML with actual IDs substituted
    v_bpmn_xml := format(
        $xml$<?xml version="1.0" encoding="UTF-8"?>
<bpmn:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:custom_1="http://custom.bpmn.io/schema" xmlns:custom="http://workflow.platform/schema/custom" id="Definitions_SimpleApproval12" targetNamespace="http://bpmn.io/schema/bpmn">
  <bpmn:process id="SimpleApprovalProcess12" name="Simple Approval Process 12" isExecutable="true">
  ...
  <bpmndi:BPMNDiagram id="BPMNDiagram_1">
    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="SimpleApprovalProcess12">
