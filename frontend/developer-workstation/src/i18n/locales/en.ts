export default {
  ...
  properties: {
    ...
    emailConfig: 'Send an email (V2)',
    emailConnection: 'Connection',
    emailConnectionPlaceholder: 'Select SMTP connection',
    emailConnectionHint: 'SMTP account used to authenticate and send mail.',
    ...
    emailFromPlaceholder: "sender{'@'}example.com or $'{'form.email'}'",
    emailFromHint: 'Sender address shown to recipients (supports expressions).',
    emailTo: 'To',
    emailToPlaceholder: "user{'@'}example.com; $'{'initiator'}'",
    emailToHint: "Separate multiple recipients with semicolons. Use $'{'initiator'}' for process starter email.",
    emailCc: 'Cc',
    emailCcPlaceholder: 'Optional; separate with semicolons',
    emailBcc: 'Bcc',
    emailBccPlaceholder: 'Optional; separate with semicolons',
    emailSubject: 'Subject',
    emailSubjectPlaceholder: "Notification: $'{'businessKey'}'",
    emailBody: 'Body',
    emailBodyPlaceholder: "Email body (HTML supported; $'{'variable'}' expressions allowed)",
    ...
    emailAttachmentContent: 'Attachment Content',
    emailAttachmentContentPlaceholder: "Base64 content or $'{'variable'}'",
    emailAddAttachment: 'Add new item',
    ...
    emailReplyToPlaceholder: 'Optional reply-to address',
