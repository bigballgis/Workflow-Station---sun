<template>
  ...
  >
    ...
    >
      ...
      <SubTableField
        :config="{ title: item.binding.tableName, columns: item.binding.columns, bindingId: item.binding.bindingId, tableId: item.binding.tableId, fieldDefinitions: item.binding.fieldDefinitions, bindingLinkMode: item.binding.bindingLinkMode, bindingForeignKeyField: item.binding.bindingForeignKeyField, bindingType: item.binding.bindingType, fkFillSources: item.binding.fkFillSources }"
