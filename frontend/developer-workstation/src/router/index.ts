...
router.beforeEach(async (to, from, next) => {
  // 设置页面标题
  const title = (to.meta as any)?.title || '开发者工作站'
  document.title = `${title} - Developer Workstation`
