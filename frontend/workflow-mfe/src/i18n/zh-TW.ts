export default {
  ...
  gateway: {
    subscriptionApprovals: '訂閱審批',
    pending: '待審批',
    approved: '已批准',
    rejected: '已拒絕',
    noPendingApprovals: '暫無待審批的訂閱請求',
    requester: '申請人',
    application: '應用',
    requestId: '請求ID',
    apiVersions: 'API版本',
    ...
    approve: '批准',
    reject: '拒絕',
    approveSubscription: '批准訂閱',
    rejectSubscription: '拒絕訂閱',
    commentPlaceholder: '請輸入審批意見',
    subscriptionApproved: '訂閱已批准',
    subscriptionRejected: '訂閱已拒絕',
  },
