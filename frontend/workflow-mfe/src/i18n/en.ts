export default {
  ...
  gateway: {
    ...
    approved: 'Approved',
    rejected: 'Rejected',
    noPendingApprovals: 'No pending subscription requests',
    requester: 'Requester',
    ...
    rejectSubscription: 'Reject Subscription',
  ...
  // MFE (Micro Frontend) Module Loading
  mfe: {
    loading: 'Loading module...',
    unavailable: 'Module Unavailable',
    retry: 'Retry',
    loadFailed: 'Failed to load module',
    noRemoteUrl: 'No remote entry URL configured'
  },
  validation: {
