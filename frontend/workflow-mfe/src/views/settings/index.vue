            ...
            <div class="portal-card">
              <el-form label-width="150px">
                <el-form-item :label="t('settings.taskAssignedNotification')">
                  <el-switch
                    v-model="notificationSettings.taskAssigned.email"
                    :active-text="t('settings.email')"
                  />
                  <el-switch
                    v-model="notificationSettings.taskAssigned.browser"
                    :active-text="t('settings.browser')"
                    style="margin-left: 20px;"
                  />
                  <el-switch
                    v-model="notificationSettings.taskAssigned.inApp"
                    :active-text="t('settings.inApp')"
                    style="margin-left: 20px;"
                  />
                </el-form-item>
                <el-form-item :label="t('settings.taskOverdueReminder')">
                  <el-switch
                    v-model="notificationSettings.taskOverdue.email"
                    :active-text="t('settings.email')"
                  />
                  <el-switch
                    v-model="notificationSettings.taskOverdue.browser"
                    :active-text="t('settings.browser')"
                    style="margin-left: 20px;"
                  />
                  <el-switch
                    v-model="notificationSettings.taskOverdue.inApp"
                    :active-text="t('settings.inApp')"
                    style="margin-left: 20px;"
                  />
                </el-form-item>
                <el-form-item :label="t('settings.processCompletedNotification')">
                  <el-switch
                    v-model="notificationSettings.processCompleted.email"
                    :active-text="t('settings.email')"
                  />
                  <el-switch
                    v-model="notificationSettings.processCompleted.browser"
                    :active-text="t('settings.browser')"
                    style="margin-left: 20px;"
                  />
                  <el-switch
                    v-model="notificationSettings.processCompleted.inApp"
                    :active-text="t('settings.inApp')"
                    style="margin-left: 20px;"
                  />
                </el-form-item>
              ...
              >
                <el-form-item :label="t('settings.timezone')">
                  ...
                  >
                    <el-option
                      value="Asia/Shanghai"
                      :label="t('settings.timezoneShanghai')"
                    />
                    <el-option
                      value="Asia/Hong_Kong"
                      :label="t('settings.timezoneHongKong')"
                    />
                    <el-option
                      value="Asia/Tokyo"
                      :label="t('settings.timezoneTokyo')"
                    />
                  </el-select>
                </el-form-item>
                <el-form-item :label="t('settings.dateFormat')">
                  <el-select
                    v-model="preferenceForm.dateFormat"
                    style="width: 300px;"
                  >
                    <el-option
                      value="YYYY-MM-DD"
                ...
                <el-form-item :label="t('settings.pageSize')">
                  <el-select
                    v-model="preferenceForm.pageSize"
                    style="width: 300px;"
                  >
                    <el-option
                      :value="10"
                      :label="t('settings.itemsPerPage', { count: 10 })"
                    />
                    <el-option
                      :value="20"
                      :label="t('settings.itemsPerPage', { count: 20 })"
                    />
                    <el-option
                      :value="50"
                      :label="t('settings.itemsPerPage', { count: 50 })"
                    />
                    <el-option
                      :value="100"
                      :label="t('settings.itemsPerPage', { count: 100 })"
                    />
                  </el-select>
                </el-form-item>
                <el-form-item>
