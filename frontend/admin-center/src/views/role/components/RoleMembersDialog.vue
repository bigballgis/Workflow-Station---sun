<template>
  ...
  >
      ...
      >
        ...
        >
          ...
          <span
            v-else
            class="text-muted"
          >{{ t('role.noVirtualGroupBound') }}</span>
        </el-descriptions-item>
      </el-descriptions>
    </el-card>
    ...
    <el-empty
      v-if="members.length === 0 && !loading && boundVirtualGroup"
