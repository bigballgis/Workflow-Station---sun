  ...
  <div class="gateway-page">
    <div class="page-header">
      ...
      <div class="header-controls">
        ...
        <el-select v-model="period" @change="fetchOverview" style="width: 120px; margin-left: 8px">
    ...
    <div class="api-metrics-section" v-if="overview">
...
import { getMonitoringOverview, getApiMetrics } from '@/domains/gateway/api/gateway'
...
const fetchApiMetrics = async () => {
  ...
  try {
    ...
    apiMetrics.value = res.data.content || []
    apiTotal.value = res.data.totalElements || 0
  } catch {
    apiMetrics.value = []
  } finally {
