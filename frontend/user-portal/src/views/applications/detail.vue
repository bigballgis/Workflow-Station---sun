          ...
          <template v-if="diagramSelectedBottomSubTables.length > 0">
            ...
            >
              ...
              <SubTableInlineForm
                ...
                :form-options="binding.formOptions"
                :dialog-columns="binding.dialogColumns"
                :assignment-config="binding.assignmentConfig"
                :primary-key-fields="binding.primaryKeyFields"
