...
export const MI_REGRESSION_SCENARIOS = [
  {
    ...
    screenshots: ['app-*-details-unprocessed.png', 'app-*-details-completed.png'],
  },
  {
    ...
    screenshots: ['task-*-sex-before.png', 'task-*-sex-after.png'],
  },
  {
    ...
    screenshots: ['task-*-attachment-table.png', 'task-*-subtask-grid.png'],
  },
  {
    ...
    screenshots: ['task-*-subform2-people.png'],
  },
  {
    ...
    screenshots: ['task-*-people-inline-uuid.png'],
  },
  {
    ...
    screenshots: ['task-*-assignee-subtask-slice.png'],
  },
]
