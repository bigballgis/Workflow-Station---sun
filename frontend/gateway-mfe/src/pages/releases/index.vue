<template>
  <div class="page-container">
    <div class="page-header">
      <span class="page-title">{{ t('gateway.releases') }}</span>
      ...
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column :label="t('common.operation')" width="340">
          <template #default="{ row }">
            ...
            <el-button v-if="row.state === 'TESTING'" link type="primary" @click="handlePublish(row)">
              {{ t('gateway.publish') }}
            </el-button>
            <el-button v-if="row.state === 'PUBLISHED'" link type="primary" @click="showPromoteDialog(row)">
              {{ t('gateway.promote') }}
            </el-button>
            ...
            <el-button v-if="row.approvalStatus === 'PENDING'" link type="primary" @click="handleApprove(row)">
              {{ t('gateway.approve') }}
            </el-button>
          </template>
        </el-table-column>
