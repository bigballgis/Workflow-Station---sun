...
// HERMES: CE reimplementation of the project-role data-access service, moved out of
// app/ee (AG-EE / EE_REMOVAL_PLAN G2/G15). Standard CRUD over the MIT-DDL project_role /
// project_member tables — no EE-proprietary logic. Consumed by the RBAC service (G2).
