    ...
    async getAll(): Promise<Flag[]> {
        ...
        flags.push(
            ...
            },
            {
                ...
                // HERMES: agents domain removed (FR-D2) — feature is permanently off, same
                // treatment as TOOL_SEARCH_ENABLED / SMTP_CONFIGURED / PGVECTOR_AVAILABLE
                // below. Upstream shipped an unconditional `true` behind a TODO, which after
                // the trim advertised a capability nothing in this build can serve.
                value: false,
                created,
                updated,
            },
            ...
            },
            {
                ...
                // HERMES: tool-search domain removed (FR-D2) — feature is permanently off.
                value: false,
                created,
                updated,
            },
            ...
            },
            {
                ...
                // HERMES: knowledge-base domain removed (FR-D2) — nothing consumes pgvector.
                value: false,
                created,
                updated,
            },
