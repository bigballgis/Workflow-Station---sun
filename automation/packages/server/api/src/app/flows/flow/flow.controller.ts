...
// HERMES: ee rbac-middleware removed (AG-EE); CE wrapper lives in core/security/v2 (G2/G11).
...
export const flowController: FastifyPluginAsyncZod = async (app) => {
    ...
    app.post('/:id', {
        ...
        // HERMES: EE platform-plan / project-plan active-flows limits removed (AG-EE / G11).
