...
describe('cursor pagination with duplicate timestamps', () => {
    ...
    // HERMES: the reserved-SQL-word pagination case used /v1/tables, which is gone with the
    // tables domain (FR-D2). The pagination helper itself is still covered by the folder cases
    // above and the cursor cases below.
