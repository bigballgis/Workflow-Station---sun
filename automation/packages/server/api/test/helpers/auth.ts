...
import { DefaultProjectRole, PlatformRole, Principal, SigningKeyId } from '@activepieces/shared'
...
export const generateMockExternalToken = (
    ...
    // HERMES: the CE managed-authn contract (externalUserId/externalProjectId/firstName/
    // lastName/email?/role/platformRole) replaced the ee payload — the ee-only pieces /
    // pieceSet / concurrencyPool fields went with the EE strip.
