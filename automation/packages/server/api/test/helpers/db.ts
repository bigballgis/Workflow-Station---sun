...
export const db = {
    ...
    // HERMES: ported from the 0.84 fork — the managed-authn CE test asserts a shadow user
    // gets exactly ONE personal project across repeated handshakes, which needs findBy.
