...
import { DefaultProjectRole, Platform, PlatformRole, PrincipalType, Project, User, UserIdentity } from '@activepieces/shared'
...
// HERMES: createServiceContext removed — SERVICE principals came from the EE api-key module,
// which went with the EE strip (G6). No service token can be minted in this build.
