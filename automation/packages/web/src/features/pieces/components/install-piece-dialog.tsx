    ...
    <Dialog open={isOpen} onOpenChange={(open) => setIsOpen(open)}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {/* HERMES-PATCH-023: the "custom piece" markdown link pointed at
                upstream piece-authoring docs — dead air-gapped, and this fork's
                piece contract diverges from it. Text kept, link dropped. */}
            <ApMarkdown
              markdown={
