...
function OAuth2ConnectionSettings({
  ...
  // HERMES-PATCH-023: the CLOUD_OAUTH2 branch used to hand out
  // secrets.activepieces.com/redirect (Activepieces' hosted OAuth
  // broker). We never proxy OAuth through a third party, and the host is
  // unreachable air-gapped; the cloud OAuth app list is gone too
  // (features/connections/api/oauth-apps.ts), so this branch is unreachable.
