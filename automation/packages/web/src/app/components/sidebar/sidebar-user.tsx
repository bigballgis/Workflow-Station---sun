        ...
        <DropdownMenu modal>
          ...
          >
            ...
            <DropdownMenuGroup>
              ...
              {/* HERMES-PATCH-023: <HelpAndFeedback/> deleted — its only entries were
                  upstream docs / GitHub releases / community.activepieces.com, all
                  unreachable in the air-gapped deployment and pointing at a product
                  this fork no longer matches (12 feature domains trimmed). */}
            </DropdownMenuGroup>
            <DropdownMenuSeparator />
