...
export function ProjectDashboardSidebar({
  ...
  // HERMES FR-D2: chat / templates(Explore) / impact links removed with their
  // domains; the sidebar keeps only project navigation.
  const items: SidebarItemType[] = [].filter(permissionFilter);
