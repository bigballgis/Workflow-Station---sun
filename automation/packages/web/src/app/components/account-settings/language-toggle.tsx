...
export const LanguageToggle = () => {
  ...
  return (
    <div className="space-y-2">
      ...
      {/* HERMES-PATCH-023: "Help translate Activepieces →" link removed — it
          pointed at upstream i18n contribution docs, unreachable air-gapped and
          irrelevant for a hard fork whose locale files are maintained in-repo. */}
    </div>
  );
};
