...
export const BuilderHeader = () => {
  ...
  // HERMES-PATCH-023: the SHOW_COMMUNITY-gated "Support" button (it opened
  // shared's supportUrl = community.activepieces.com) is gone — SHOW_COMMUNITY
  // is true for CE, so it rendered a link that can never resolve air-gapped.
