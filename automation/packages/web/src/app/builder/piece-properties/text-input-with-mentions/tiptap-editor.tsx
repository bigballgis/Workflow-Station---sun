    ...
    <div className="relative w-full" ref={editorWrapperRef}>
      ...
      {slashState.open && (
        <FunctionSearchPopover
          ...
          onClose={closeSlash}
          // HERMES-PATCH-023: no upstream-docs fallback; only an embedding host
          // may supply a formulas docs URL, otherwise the link is not rendered.
          docsUrl={embedState.formulasDocsUrl}
        />
      )}
    </div>
  );
