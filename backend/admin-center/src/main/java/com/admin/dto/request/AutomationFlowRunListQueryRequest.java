...
/**
 * One page of Automation Runs. Toolbar keyword AND with header filters.
 */
public record AutomationFlowRunListQueryRequest(
        int page,
        int size,
        String keyword,
    ...
    public AutomationFlowRunListQueryRequest {
        if (page < 0) {
