...
/**
 * One page of Function Units (list or archive). Toolbar keyword ANDs with header filters
 * after latest-version-per-code has already been applied.
 */
public record FunctionUnitListQueryRequest(
        int page,
        int size,
        String keyword,
