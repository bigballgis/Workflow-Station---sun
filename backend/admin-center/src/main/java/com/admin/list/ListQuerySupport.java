...
public final class ListQuerySupport {
    ...
    public static List<AdminListGroup> groupsOf(JdbcTemplate jdbcTemplate, String groupExpression,
        ...
        return query(jdbcTemplate, sql, params, rs -> {
            ...
            while (rs.next()) {
                groups.add(new AdminListGroup(rs.getString("group_label"), rs.getLong("group_count")));
            }
            return groups;
        });
    }
