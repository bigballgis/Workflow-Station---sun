...
-- =====================================================
INSERT INTO sys_permissions (id, code, name, type, resource, action, description)
VALUES 
    -- Admin permissions
    ...
    ('perm-admin-bu-read', 'ADMIN:BU:READ', 'View Business Units', 'ADMIN', 'business_unit', 'read', 'View business unit structure'),
    ...
    ('perm-admin-config-write', 'ADMIN:CONFIG:WRITE', 'Manage System Config', 'ADMIN', 'config', 'write', 'Modify system configuration'),
    -- Developer permissions
    ('perm-dev-fu-create', 'DEV:FU:CREATE', 'Create Function Unit', 'DEVELOPER', 'function_unit', 'create', 'Create new function units'),
    ('perm-dev-fu-edit', 'DEV:FU:EDIT', 'Edit Function Unit', 'DEVELOPER', 'function_unit', 'edit', 'Edit function units'),
    ('perm-dev-fu-delete', 'DEV:FU:DELETE', 'Delete Function Unit', 'DEVELOPER', 'function_unit', 'delete', 'Delete function units'),
    ('perm-dev-fu-deploy', 'DEV:FU:DEPLOY', 'Deploy Function Unit', 'DEVELOPER', 'function_unit', 'deploy', 'Deploy function units'),
    ('perm-dev-fu-approve', 'DEV:FU:APPROVE', 'Approve Function Unit', 'DEVELOPER', 'function_unit', 'approve', 'Approve function unit deployments'),
    ('perm-dev-process-design', 'DEV:PROCESS:DESIGN', 'Design Process', 'DEVELOPER', 'process', 'design', 'Design workflow processes'),
    ('perm-dev-form-design', 'DEV:FORM:DESIGN', 'Design Form', 'DEVELOPER', 'form', 'design', 'Design forms'),
    ('perm-dev-table-design', 'DEV:TABLE:DESIGN', 'Design Table', 'DEVELOPER', 'table', 'design', 'Design data tables'),
    -- Business user permissions
    ('perm-portal-task-view', 'PORTAL:TASK:VIEW', 'View Tasks', 'BUSINESS', 'task', 'view', 'View assigned tasks'),
    ('perm-portal-task-process', 'PORTAL:TASK:PROCESS', 'Process Tasks', 'BUSINESS', 'task', 'process', 'Process and complete tasks'),
    ('perm-portal-process-start', 'PORTAL:PROCESS:START', 'Start Process', 'BUSINESS', 'process', 'start', 'Start new process instances'),
    ('perm-portal-process-view', 'PORTAL:PROCESS:VIEW', 'View Process', 'BUSINESS', 'process', 'view', 'View process instances')
...
INSERT INTO sys_role_permissions (id, role_id, permission_id, granted_at, granted_by)
SELECT 
    'rp-sysadmin-' || p.id,
    'SYS_ADMIN_ROLE',
    p.id,
...
-- TEAM_LEAD: All permissions (22 permissions)
INSERT INTO sys_developer_role_permissions (id, role_id, permission, created_at)
SELECT 
    gen_random_uuid()::varchar,
    'role-team-lead',
...
-- DEVELOPER: Limited permissions (9 permissions - view and update only, no create or delete)
INSERT INTO sys_developer_role_permissions (id, role_id, permission, created_at)
SELECT 
    gen_random_uuid()::varchar,
    'role-developer',
...
VALUES 
    -- User Status
    ('sys-item-001', 'sys-dict-001', 'ACTIVE', 'Active', 'Active', '鍚敤', 'ACTIVE', 'ACTIVE', 1, NOW(), NOW()),
    ('sys-item-002', 'sys-dict-001', 'INACTIVE', 'Inactive', 'Inactive', '绂佺敤', 'INACTIVE', 'ACTIVE', 2, NOW(), NOW()),
    ('sys-item-003', 'sys-dict-001', 'LOCKED', 'Locked', 'Locked', '閿佸畾', 'LOCKED', 'ACTIVE', 3, NOW(), NOW()),
    -- Gender
    ('sys-item-004', 'sys-dict-002', 'MALE', 'Male', 'Male', '鐢?, 'M', 'ACTIVE', 1, NOW(), NOW()),
    ('sys-item-005', 'sys-dict-002', 'FEMALE', 'Female', 'Female', '濂?, 'F', 'ACTIVE', 2, NOW(), NOW()),
    ('sys-item-006', 'sys-dict-002', 'OTHER', 'Other', 'Other', '鍏朵粬', 'O', 'ACTIVE', 3, NOW(), NOW()),
    -- Language
    ('sys-item-007', 'sys-dict-003', 'EN', 'English', 'English', '鑻辨枃', 'en', 'ACTIVE', 1, NOW(), NOW()),
    ('sys-item-008', 'sys-dict-003', 'ZH_CN', 'Simplified Chinese', 'Simplified Chinese', '绠€浣撲腑鏂?, 'zh-CN', 'ACTIVE', 2, NOW(), NOW()),
    ('sys-item-009', 'sys-dict-003', 'ZH_TW', 'Traditional Chinese', 'Traditional Chinese', '绻佷綋涓枃', 'zh-TW', 'ACTIVE', 3, NOW(), NOW()),
    -- Role Type
    ('sys-item-010', 'sys-dict-004', 'ADMIN', 'Admin', 'Admin', '绠＄悊鍛?, 'ADMIN', 'ACTIVE', 1, NOW(), NOW()),
    ('sys-item-011', 'sys-dict-004', 'DEVELOPER', 'Developer', 'Developer', '寮€鍙戣€?, 'DEVELOPER', 'ACTIVE', 2, NOW(), NOW()),
    ('sys-item-012', 'sys-dict-004', 'BUSINESS', 'Business', 'Business', '涓氬姟鐢ㄦ埛', 'BUSINESS', 'ACTIVE', 3, NOW(), NOW()),
    -- Permission Type
    ('sys-item-013', 'sys-dict-005', 'ADMIN', 'Admin Permission', 'Admin Permission', '绠＄悊鏉冮檺', 'ADMIN', 'ACTIVE', 1, NOW(), NOW()),
    ('sys-item-014', 'sys-dict-005', 'DEVELOPER', 'Developer Permission', 'Developer Permission', '寮€鍙戞潈闄?, 'DEVELOPER', 'ACTIVE', 2, NOW(), NOW()),
    ('sys-item-015', 'sys-dict-005', 'BUSINESS', 'Business Permission', 'Business Permission', '涓氬姟鏉冮檺', 'BUSINESS', 'ACTIVE', 3, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
-- =====================================================
INSERT INTO sys_users (id, username, password_hash, email, full_name, display_name, employee_id, position, status, language, created_at, updated_at)
VALUES 
    -- System users
    ('admin-001', 'admin', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'admin@example.com', 'System Administrator', 'System Admin', 'EMP-SYS-001', 'System Administrator', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('90140d0a-6fbb-4432-b07d-e208fb6ebd55', 'auditor', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'auditor@example.com', 'Auditor', 'Auditor', 'EMP-AUD-001', 'Auditor', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('aa220ecd-bb5b-4ba5-aa0a-27af144b9679', 'designer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'designer@example.com', 'Process Designer', 'Process Designer', 'EMP-DEV-001', 'Process Designer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('635281da-5dbb-4118-9610-dd4d6318dcd6', 'developer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'developer@example.com', 'Developer', 'Developer', 'EMP-DEV-002', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('b4fe69e8-7313-48c5-865b-878231c24b9f', 'dev_lead', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'dev_lead@example.com', 'Development Lead', 'Dev Lead', 'EMP-DEV-003', 'Development Lead', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('7e468949-05ea-4c41-8ab5-484fb0626185', 'senior_dev', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'senior_dev@example.com', 'Senior Developer', 'Senior Dev', 'EMP-DEV-004', 'Senior Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e9c974a2-3b71-4eba-9082-3b8d8cd03f08', 'super_admin', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'super_admin@example.com', 'Super Administrator', 'Super Admin', 'EMP-SYS-002', 'Super Administrator', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('f64d52ad-be7a-45ed-9b49-21138310b67c', 'system_admin', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'system_admin@example.com', 'System Administrator', 'Sys Admin', 'EMP-SYS-003', 'System Administrator', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('b7890c89-ef16-491b-ba2f-ef559817eb8a', 'team_lead', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'team_lead@example.com', 'Team Lead', 'Team Lead', 'EMP-MGR-001', 'Team Lead', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('fbba7111-5efb-4623-9239-27807c66fede', 'tenant_admin', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'tenant_admin@example.com', 'Tenant Administrator', 'Tenant Admin', 'EMP-SYS-004', 'Tenant Administrator', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e23b8e53-b9b0-4a7a-a704-9b1af77f97e3', 'tester', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'tester@example.com', 'QA Tester', 'Tester', 'EMP-QA-001', 'QA Tester', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Business users
    ('9ad52216-f42b-4259-84eb-5e53a8fb0a3b', 'manager', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'manager@example.com', 'Department Manager', 'Manager', 'EMP-MGR-002', 'Department Manager', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e7eb22f1-aa8a-4eda-b4b0-f52d53622b3a', 'employee_a', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'employee_a@example.com', 'Employee Zhang San', 'Zhang San', 'EMP-OPS-001', 'Operations Staff', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('c7529039-05aa-4cdc-9b12-c8efa34bd61e', 'employee_b', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'employee_b@example.com', 'Employee Li Si', 'Li Si', 'EMP-OPS-002', 'Operations Staff', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('48b3dad7-c5a9-4000-8b6b-80453e59a6da', 'finance', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'finance@example.com', 'Finance Staff', 'Finance', 'EMP-FIN-001', 'Finance Staff', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('7a55eeb0-d0cf-4b58-911d-61334643a374', 'hr_staff', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'hr_staff@example.com', 'HR Specialist', 'HR Staff', 'EMP-HR-001', 'HR Specialist', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Bank staff users
    ('channel-lead-001', 'channel.lead', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'channel.lead@bank.com', 'Grace Lin', 'Grace Lin', 'EMP-IT-001', 'Channel Development Lead', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('core-lead-001', 'core.lead', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'core.lead@bank.com', 'Kevin Huang', 'Kevin Huang', 'EMP-IT-002', 'Core Banking Lead', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-analyst-001', 'corp.analyst', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'corp.analyst@bank.com', 'David Wu', 'David Wu', 'EMP-CORP-001', 'Corporate Analyst', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-director-001', 'corp.director', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'corp.director@bank.com', 'James Zhang', 'James Zhang', 'EMP-CORP-002', 'Corporate Director', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-manager-001', 'corp.manager', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'corp.manager@bank.com', 'Linda Li', 'Linda Li', 'EMP-CORP-003', 'Corporate Manager', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-officer-001', 'corp.officer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'corp.officer@bank.com', 'Amy Zhao', 'Amy Zhao', 'EMP-CORP-004', 'Corporate Officer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('hr-manager-001', 'hr.manager', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'hr.manager@bank.com', 'Sarah Chen', 'Sarah Chen', 'EMP-HR-002', 'HR Manager', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('hr-recruiter-001', 'hr.recruiter', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'hr.recruiter@bank.com', 'Emily Liu', 'Emily Liu', 'EMP-HR-003', 'HR Recruiter', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('hr-specialist-001', 'hr.specialist', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'hr.specialist@bank.com', 'Michael Wang', 'Michael Wang', 'EMP-HR-004', 'HR Specialist', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('risk-lead-001', 'risk.lead', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'risk.lead@bank.com', 'Tony Chen', 'Tony Chen', 'EMP-RISK-001', 'Risk Lead', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('tech-director-001', 'tech.director', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'tech.director@bank.com', 'Robert Sun', 'Robert Sun', 'EMP-IT-003', 'Technical Director', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Developer users
    ('dev-alex-001', 'dev.alex', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'alex.dev@bank.com', 'Alex Zhou', 'Alex Zhou', 'EMP-DEV-005', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-emma-001', 'dev.emma', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'emma.dev@bank.com', 'Emma Liu', 'Emma Liu', 'EMP-DEV-006', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-john-001', 'dev.john', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'john.dev@bank.com', 'John Smith', 'John Developer', 'EMP-DEV-007', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-lisa-001', 'dev.lisa', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'lisa.dev@bank.com', 'Lisa Wang', 'Lisa Wang', 'EMP-DEV-008', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-mary-001', 'dev.mary', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'mary.dev@bank.com', 'Mary Johnson', 'Mary Johnson', 'EMP-DEV-009', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-peter-001', 'dev.peter', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'peter.dev@bank.com', 'Peter Lee', 'Peter Lee', 'EMP-DEV-010', 'Software Developer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Workflow test users
    ('countersign-001', 'countersign.approver1', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'daniel.brown@example.com', 'Daniel Brown', 'Daniel', 'EMP-WF-001', 'Countersign Approver', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('countersign-002', 'countersign.approver2', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'eva.martinez@example.com', 'Eva Martinez', 'Eva', 'EMP-WF-002', 'Countersign Approver', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dept-reviewer-001', 'dept.reviewer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'alice.johnson@example.com', 'Alice Johnson', 'Alice', 'EMP-WF-003', 'Department Reviewer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('finance-reviewer-001', 'finance.reviewer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'carol.davis@example.com', 'Carol Davis', 'Carol', 'EMP-WF-004', 'Finance Reviewer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('parent-reviewer-001', 'parent.reviewer', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'bob.smith@example.com', 'Bob Smith', 'Bob', 'EMP-WF-005', 'Parent Reviewer', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('purchase-requester-001', 'purchase.requester', '$2a$10$XMfQkI8Q4i2ZOLcl.V5RH.SoLTbPpfsxbv0YG21jRr8F7zhNouMle', 'tom.wilson@example.com', 'Tom Wilson', 'Tom', 'EMP-WF-006', 'Purchase Requester', 'ACTIVE', 'zh_CN', NOW(), NOW())
...
VALUES 
    ...
    ('vgm-admin-sysadmins', 'vg-sys-admins', 'admin-001', NOW()),
    -- Auditors
    ('vgm-auditor-auditors', 'vg-auditors', '90140d0a-6fbb-4432-b07d-e208fb6ebd55', NOW()),
    -- Developers
    ('vgm-corpofficer-developers', 'vg-developers', 'corp-officer-001', NOW()),
    -- Branch Managers
    ('vgm-corpmanager-branchmanagers', 'vg-branch-managers', 'corp-manager-001', NOW()),
    ('vgm-hrmanager-branchmanagers', 'vg-branch-managers', 'hr-manager-001', NOW()),
    -- Compliance Officers
    ('vgm-corpofficer-complianceofficers', 'vg-compliance-officers', 'corp-officer-001', NOW()),
    -- Countersign Approvers
    ('vgm-countersign1-countersignapprovers', 'vg-countersign-approvers', 'countersign-001', NOW()),
    ('vgm-countersign2-countersignapprovers', 'vg-countersign-approvers', 'countersign-002', NOW()),
    -- Department Supervisors
    ('vgm-channellead-deptsupervisors', 'vg-dept-supervisors', 'channel-lead-001', NOW()),
    ('vgm-corelead-deptsupervisors', 'vg-dept-supervisors', 'core-lead-001', NOW()),
    -- General Users
    ('vgm-countersign1-generalusers', 'vg-general-users', 'countersign-001', NOW()),
    ('vgm-countersign2-generalusers', 'vg-general-users', 'countersign-002', NOW()),
    ('vgm-deptreviewer-generalusers', 'vg-general-users', 'dept-reviewer-001', NOW()),
    ('vgm-financereviewer-generalusers', 'vg-general-users', 'finance-reviewer-001', NOW()),
    ('vgm-parentreviewer-generalusers', 'vg-general-users', 'parent-reviewer-001', NOW()),
    ('vgm-purchaserequester-generalusers', 'vg-general-users', 'purchase-requester-001', NOW()),
    -- Loan Officers
    ('vgm-corpanalyst-loanofficers', 'vg-loan-officers', 'corp-analyst-001', NOW()),
    ('vgm-corpofficer-loanofficers', 'vg-loan-officers', 'corp-officer-001', NOW()),
    -- Risk Analysts
