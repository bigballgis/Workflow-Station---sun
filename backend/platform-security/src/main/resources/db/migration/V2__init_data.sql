...
VALUES 
    ...
    ('90140d0a-6fbb-4432-b07d-e208fb6ebd55', 'auditor', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'auditor@example.com', '审计员', '审计员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('aa220ecd-bb5b-4ba5-aa0a-27af144b9679', 'designer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'designer@example.com', '流程设计师', '流程设计师', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('635281da-5dbb-4118-9610-dd4d6318dcd6', 'developer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'developer@example.com', '开发人员', '开发人员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('b4fe69e8-7313-48c5-865b-878231c24b9f', 'dev_lead', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'dev_lead@example.com', '开发组长', '开发组长', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('7e468949-05ea-4c41-8ab5-484fb0626185', 'senior_dev', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'senior_dev@example.com', '高级开发', '高级开发', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e9c974a2-3b71-4eba-9082-3b8d8cd03f08', 'super_admin', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'super_admin@example.com', '超级管理员', '超级管理员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('f64d52ad-be7a-45ed-9b49-21138310b67c', 'system_admin', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'system_admin@example.com', '系统管理员', '系统管理员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('b7890c89-ef16-491b-ba2f-ef559817eb8a', 'team_lead', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'team_lead@example.com', '团队主管', '团队主管', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('fbba7111-5efb-4623-9239-27807c66fede', 'tenant_admin', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'tenant_admin@example.com', '租户管理员', '租户管理员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e23b8e53-b9b0-4a7a-a704-9b1af77f97e3', 'tester', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'tester@example.com', '测试人员', '测试人员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Business users
    ('9ad52216-f42b-4259-84eb-5e53a8fb0a3b', 'manager', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'manager@example.com', '部门经理', '部门经理', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('e7eb22f1-aa8a-4eda-b4b0-f52d53622b3a', 'employee_a', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'employee_a@example.com', '员工张三', '员工张三', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('c7529039-05aa-4cdc-9b12-c8efa34bd61e', 'employee_b', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'employee_b@example.com', '员工李四', '员工李四', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('48b3dad7-c5a9-4000-8b6b-80453e59a6da', 'finance', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'finance@example.com', '财务人员', '财务人员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('7a55eeb0-d0cf-4b58-911d-61334643a374', 'hr_staff', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'hr_staff@example.com', 'HR专员', 'HR专员', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Bank staff users
    ('channel-lead-001', 'channel.lead', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'channel.lead@bank.com', 'Grace Lin', 'Grace Lin', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('core-lead-001', 'core.lead', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'core.lead@bank.com', 'Kevin Huang', 'Kevin Huang', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-analyst-001', 'corp.analyst', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'corp.analyst@bank.com', 'David Wu', 'David Wu', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('corp-director-001', 'corp.director', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'corp.director@bank.com', 'James Zhang', 'James Zhang', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ...
    ('corp-officer-001', 'corp.officer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'corp.officer@bank.com', 'Amy Zhao', 'Amy Zhao', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ...
    ('hr-recruiter-001', 'hr.recruiter', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'hr.recruiter@bank.com', 'Emily Liu', 'Emily Liu', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('hr-specialist-001', 'hr.specialist', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'hr.specialist@bank.com', 'Michael Wang', 'Michael Wang', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('risk-lead-001', 'risk.lead', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'risk.lead@bank.com', 'Tony Chen', 'Tony Chen', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ...
    -- Developer users
    ('dev-alex-001', 'dev.alex', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'alex.dev@bank.com', 'Alex Zhou', 'Alex Zhou', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-emma-001', 'dev.emma', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'emma.dev@bank.com', 'Emma Liu', 'Emma Liu', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ...
    ('dev-lisa-001', 'dev.lisa', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'lisa.dev@bank.com', 'Lisa Wang', 'Lisa Wang', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-mary-001', 'dev.mary', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'mary.dev@bank.com', 'Mary Johnson', 'Mary Johnson', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dev-peter-001', 'dev.peter', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'peter.dev@bank.com', 'Peter Lee', 'Peter Lee', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    -- Workflow test users
    ('countersign-001', 'countersign.approver1', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'daniel.brown@example.com', 'Daniel Brown', 'Daniel', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('countersign-002', 'countersign.approver2', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'eva.martinez@example.com', 'Eva Martinez', 'Eva', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('dept-reviewer-001', 'dept.reviewer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'alice.johnson@example.com', 'Alice Johnson', 'Alice', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('finance-reviewer-001', 'finance.reviewer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'carol.davis@example.com', 'Carol Davis', 'Carol', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('parent-reviewer-001', 'parent.reviewer', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'bob.smith@example.com', 'Bob Smith', 'Bob', 'ACTIVE', 'zh_CN', NOW(), NOW()),
    ('purchase-requester-001', 'purchase.requester', '$2a$10$bTB3yyVtzpJw17uMI9pShOzAkm07MKZa2EyQhc4izBO1MdXXEiUiO', 'tom.wilson@example.com', 'Tom Wilson', 'Tom', 'ACTIVE', 'zh_CN', NOW(), NOW())
