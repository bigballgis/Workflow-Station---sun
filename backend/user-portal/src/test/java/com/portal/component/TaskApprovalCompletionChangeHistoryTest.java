...
class TaskApprovalCompletionChangeHistoryTest {
    @Test
    @DisplayName("uses the pre-completion process state when the task has no save baseline")
    void usesPreSyncSubTablesWhenTaskWasNotSaved() {
        ...
        Object resolved = TaskApprovalCompletionComponent.resolveSubTableHistoryBaseline(null, preSyncVariables);
