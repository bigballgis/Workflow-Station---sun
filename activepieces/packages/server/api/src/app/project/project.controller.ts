import { ActivepiecesError, CreateProjectRequest as CreateProjectRequestBody, DefaultProjectRole, ErrorCode, isNil, Permission, PiecesFilterType, Principal, PrincipalType, Project, ProjectType, ProjectWithLimits, SeekPage, SERVICE_KEY_SECURITY_OPENAPI, spreadIfDefined, TeamProjectsLimit, UpdateProjectRequest as UpdateProjectRequestBody } from '@activepieces/shared'
        ...
        case TeamProjectsLimit.ONE: {
            ...
            if (teamProjects >= 1) {
                throw new ActivepiecesError({
                    ...
                    params: {
                        message: 'Maximum of 1 team project reached for this platform plan',
                    },
                })
            }
            break
