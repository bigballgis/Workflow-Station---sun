...
// HERMES: CE reimplementation of the project-member data-access + role-resolution service,
// moved out of app/ee (AG-EE / EE_REMOVAL_PLAN G2). Standard CRUD + the RBAC role
// resolution (owner/platform-admin/operator/member) over the MIT-DDL project_member table.
// No EE-proprietary logic. getRole is the authoritative role source for the RBAC service.
