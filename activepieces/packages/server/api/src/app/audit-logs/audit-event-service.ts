...
// CE reimplementation of the (removed) ee audit-event service. setup() hangs a
// persistence listener on the same applicationEvents registry that feeds event
// streaming, so every sendUserEvent/sendWorkerEvent call site (flows,
// connections, folders, sign-in, signing keys, ...) lands here for free.
