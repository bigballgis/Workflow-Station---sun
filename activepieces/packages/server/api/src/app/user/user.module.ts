...
// depend only on CE services (userService.getOneByIdAndPlatformIdOrThrow already returns
// UserWithBadges, fileService.uploadPublicAsset and userIdentityService are core).
