...
| Portal/Admin 侧栏或记录列表（`el-table` 主列表、Layout 菜单、`ListColumnHeader` / `ListPagination`） | `shared-list-portal-admin` + [shared-list-components.md](../../../docs/design/shared-list-components.md) §6.7（表头 / kind 筛选排序 / 列宽 / 分页）；列宽余量再加 §6.6 |
