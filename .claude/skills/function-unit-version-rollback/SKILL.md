...
与可移植性总纲配套：`.claude/skills/function-unit-portability/SKILL.md`  
View 访问规则语义：`.claude/skills/view-access-control/SKILL.md`
...
- 可移植性总纲：`.claude/skills/function-unit-portability/SKILL.md`
- View 规则：`.claude/skills/view-access-control/SKILL.md`
